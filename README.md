...
## Müşteri alışveriş tutarlarında 50.000 ve üzeri high value- 30.000/50.000 arası medium- 30.000 altı low value olarak segmente edildi
...
## Teslimat süresi-Öncelikle müşterinin istediği tarih ve sipariş tarihi arasında geçen zamana bakıldı. Daha sonra sevk tarihi ve sipariş tarihi arasında ki fark incelendi ve istenen tarih ve sevk tarihi arasındaki fark incelendi. Teslim tarihi veri setinde yoktu.
...
## Aylık ciro (Discount oranı dahilinde gelir hesaplanmıştır.)
...
## Yeniden satın alınan ürünler ve yıllık ciroları
...
## Çalışan Analizi-Hangi çalışan ne kadar satış yaptı ve ne kadar gelir getirdi
